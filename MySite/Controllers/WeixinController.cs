...
{
    using MySite.CommonService.MessageHandlers.CustomMessageHandler;
    using Senparc.Weixin.MP.MvcExtension;

    public partial class WeixinController : Controller
    {
        public static readonly string Token = "mysite7172";//与微信公众账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey = "YourKey";//与微信公众账号后台的EncodingAESKey设置保持一致，区分大小写。
        public static readonly string AppId = "wx6be000cf56e42d6b";//与微信公众账号后台的AppId设置保持一致，区分大小写。

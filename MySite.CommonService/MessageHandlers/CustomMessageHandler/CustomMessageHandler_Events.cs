...
using MySite.CommonService.Download;
using Senparc.Weixin.MP.Containers;
using Senparc.Weixin.MP.AdvancedAPIs;
using Senparc.Weixin.MP;
using MySite.CommonService.Utilities;

namespace MySite.CommonService.MessageHandlers.CustomMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
    /// </summary>
...
© 2016 Senparc", codeRecord.Version, codeRecord.IsWebVersion ? "网页版" : ".chm文档版");
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            responseMessage.Content = requestMessage.FromUserName + Environment.NewLine + GetWelcomeInfo();
            if (!string.IsNullOrEmpty(requestMessage.EventKey))
            {

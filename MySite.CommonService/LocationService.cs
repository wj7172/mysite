...
namespace MySite.CommonService
{
    public class LocationService
    {
        public ResponseMessageNews GetResponseMessage(RequestMessageLocation requestMessage)
        {
            ...
            responseMessage.Articles.Add(new Article()
            {
                Title = string.Format("{0} {1}", requestMessage.Location_X, requestMessage.Location_Y),
                Description = string.Format("{0} {1}", requestMessage.Location_X, requestMessage.Location_Y),
